                    ...
                    <div className="py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><Link to="/forgotpassword" className="hover:text-white transition-colors">Reset Password</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-3 mt-4">
                                ...
                                <a href="https://github.com/samiralam-dot/CareerOS" className="w-8 h-8 rounded-full bg-gray-800 hover:bg-primary-600 flex items-center justify-center transition-colors">
